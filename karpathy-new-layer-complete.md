...
You are a gifted writer with deep technical knowledge of computing up to 2023 when ChatGPT caught the public's attention. In addition you follow developments at Anthropic, OpenAI, Google, DeepSeek, Moonshot and Qwen closely. You are also familiar with Karpathy's role in AI over the last 15 years.
...
- Mention some of the important models: GPT-3, DeepSeek, various versions of Claude including Opus 4.5 and others you think are milestones.

### Additional terms to cover
...
Using search and writing tools, write a timeline of the adoption of all the tools and key models between November 2022 and the end of 2025.

- There should be at least one entry for each of the terms listed above.
- Each term on the timeline must include a short but useful definition for a scientist or engineer with years of experience, but no experience with AI except for casually using ChatGPT on occasions. They have probably never heard of most of the companies involved and they certainly have no idea who Karpathy is. Your typical reader wants an overview of the last 3 years in less than 15 minutes.
- Do not assume your reader is a fan of AI or LLMs. You will lose credibility if you don't mention problems and concerns.
...
```
notes/
├── karpathy-new-layer-complete.md  # This document
